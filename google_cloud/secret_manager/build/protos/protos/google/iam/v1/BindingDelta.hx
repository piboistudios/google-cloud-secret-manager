...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.iam.v1.BindingDelta") extern class BindingDelta {
	/**
	...
	**/
	...
	/**
		BindingDelta action.
	**/
	public var action : ts.AnyOf2<Int, String>;
	/**
		BindingDelta role.
	**/
	...
	**/
	@:optional
	public var condition : google_cloud.secret_manager.build.protos.protos.google.type.IExpr;
	/**
