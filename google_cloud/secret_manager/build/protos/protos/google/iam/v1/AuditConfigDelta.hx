...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.iam.v1.AuditConfigDelta") extern class AuditConfigDelta {
	/**
	...
	**/
	public var action : ts.AnyOf2<String, Int>;
	/**
