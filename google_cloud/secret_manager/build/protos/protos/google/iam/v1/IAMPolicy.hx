...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.iam.v1.IAMPolicy") extern class IAMPolicy extends protobufjs.rpc.Service {
	/**
	...
	**/
	...
	public function setIamPolicy(request:ISetIamPolicyRequest, callback:google_cloud.secret_manager.build.protos.protos.google.iam.v1.iampolicy.SetIamPolicyCallback):Void;
	/**
		Calls GetIamPolicy.
	...
	**/
	...
	public function getIamPolicy(request:IGetIamPolicyRequest, callback:google_cloud.secret_manager.build.protos.protos.google.iam.v1.iampolicy.GetIamPolicyCallback):Void;
	/**
	...
	**/
	...
	public function testIamPermissions(request:ITestIamPermissionsRequest, callback:google_cloud.secret_manager.build.protos.protos.google.iam.v1.iampolicy.TestIamPermissionsCallback):Void;
	/**
