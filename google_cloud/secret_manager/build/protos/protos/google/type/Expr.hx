package google_cloud.secret_manager.build.protos.protos.google.type;

/**
	Represents an Expr.
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.type.Expr") extern class Expr {
	/**
