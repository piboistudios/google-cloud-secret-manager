...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.cloud.secretmanager.v1.SecretVersion") extern class SecretVersion {
	/**
	...
	**/
	...
	/**
		SecretVersion state.
	**/
	public var state : ts.AnyOf2<Int, String>;
	/**
		SecretVersion replicationStatus.
	**/
	@:optional
	public var replicationStatus : IReplicationStatus;
	/**
		SecretVersion etag.
	**/
