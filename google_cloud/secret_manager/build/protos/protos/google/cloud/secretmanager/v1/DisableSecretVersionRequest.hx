...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.cloud.secretmanager.v1.DisableSecretVersionRequest") extern class DisableSecretVersionRequest {
	/**
