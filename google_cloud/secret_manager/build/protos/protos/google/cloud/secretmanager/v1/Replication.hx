...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.cloud.secretmanager.v1.Replication") extern class Replication {
	/**
	...
	**/
	@:optional
	public var automatic : google_cloud.secret_manager.build.protos.protos.google.cloud.secretmanager.v1.replication.IAutomatic;
	/**
		Replication userManaged.
	**/
	@:optional
	public var userManaged : google_cloud.secret_manager.build.protos.protos.google.cloud.secretmanager.v1.replication.IUserManaged;
	/**
