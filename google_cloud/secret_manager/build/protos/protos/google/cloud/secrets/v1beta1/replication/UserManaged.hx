...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.cloud.secrets.v1beta1.Replication.UserManaged") extern class UserManaged {
	/**
	...
	**/
	public var replicas : Array<google_cloud.secret_manager.build.protos.protos.google.cloud.secrets.v1beta1.replication.usermanaged.IReplica>;
	/**
