...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.cloud.secrets.v1beta1.EnableSecretVersionRequest") extern class EnableSecretVersionRequest {
	/**
