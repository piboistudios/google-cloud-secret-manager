package google_cloud.secret_manager.build.protos.protos.google.cloud.secrets.v1beta1.replication.usermanaged;

/**
	Represents a Replica.
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.cloud.secrets.v1beta1.Replication.UserManaged.Replica") extern class Replica {
	/**
