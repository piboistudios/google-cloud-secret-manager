...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.FieldOptions") extern class FieldOptions {
	/**
	...
	**/
	...
	/**
		FieldOptions ctype.
	**/
	public var ctype : ts.AnyOf2<Int, String>;
	/**
		FieldOptions packed.
	**/
	...
	/**
		FieldOptions jstype.
	**/
	public var jstype : ts.AnyOf2<Int, String>;
	/**
		FieldOptions lazy.
	**/
