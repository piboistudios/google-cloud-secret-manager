package google_cloud.secret_manager.build.protos.protos.google.protobuf.descriptorproto;

/**
	Represents an ExtensionRange.
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.DescriptorProto.ExtensionRange") extern class ExtensionRange {
	/**
	...
	**/
	@:optional
	public var options : google_cloud.secret_manager.build.protos.protos.google.protobuf.IExtensionRangeOptions;
	/**
