package google_cloud.secret_manager.build.protos.protos.google.protobuf.uninterpretedoption;

/**
	Represents a NamePart.
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.UninterpretedOption.NamePart") extern class NamePart {
	/**
