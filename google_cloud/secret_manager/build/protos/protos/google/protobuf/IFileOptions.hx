...
typedef IFileOptions = {
	...
	**/
	@:optional
	var optimizeFor : ts.AnyOf2<Int, String>;
	/**
	...
	**/
	@:optional
	@:native(".google.api.resourceDefinition")
	var _google_api_resourceDefinition : Array<google_cloud.secret_manager.build.protos.protos.google.api.IResourceDescriptor>;
};