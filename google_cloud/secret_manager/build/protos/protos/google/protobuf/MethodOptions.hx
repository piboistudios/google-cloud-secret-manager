...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.MethodOptions") extern class MethodOptions {
	/**
	...
	**/
	public var idempotencyLevel : ts.AnyOf2<Int, String>;
	/**
