...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.UninterpretedOption") extern class UninterpretedOption {
	/**
	...
	**/
	public var name : Array<google_cloud.secret_manager.build.protos.protos.google.protobuf.uninterpretedoption.INamePart>;
	/**
	...
	**/
	public var positiveIntValue : ts.AnyOf3<String, Float, long.Long>;
	/**
		UninterpretedOption negativeIntValue.
	**/
	public var negativeIntValue : ts.AnyOf3<String, Float, long.Long>;
	/**
	...
	**/
	public var stringValue : ts.AnyOf2<String, js.lib.Uint8Array>;
	/**
