...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.SourceCodeInfo") extern class SourceCodeInfo {
	/**
	...
	**/
	public var location : Array<google_cloud.secret_manager.build.protos.protos.google.protobuf.sourcecodeinfo.ILocation>;
	/**
