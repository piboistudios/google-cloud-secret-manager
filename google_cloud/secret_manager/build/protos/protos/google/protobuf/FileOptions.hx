...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.FileOptions") extern class FileOptions {
	/**
	...
	**/
	public var optimizeFor : ts.AnyOf2<Int, String>;
	/**
