package google_cloud.secret_manager.build.protos.protos.google.protobuf.enumdescriptorproto;

/**
	Represents an EnumReservedRange.
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.EnumDescriptorProto.EnumReservedRange") extern class EnumReservedRange {
	/**
