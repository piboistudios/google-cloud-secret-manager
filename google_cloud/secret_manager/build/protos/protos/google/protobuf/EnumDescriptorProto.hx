...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.EnumDescriptorProto") extern class EnumDescriptorProto {
	/**
	...
	**/
	public var reservedRange : Array<google_cloud.secret_manager.build.protos.protos.google.protobuf.enumdescriptorproto.IEnumReservedRange>;
	/**
