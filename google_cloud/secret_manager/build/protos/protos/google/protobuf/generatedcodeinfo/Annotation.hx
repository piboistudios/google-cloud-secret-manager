package google_cloud.secret_manager.build.protos.protos.google.protobuf.generatedcodeinfo;

/**
	Represents an Annotation.
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.GeneratedCodeInfo.Annotation") extern class Annotation {
	/**
