...
typedef IDescriptorProto = {
	...
	**/
	@:optional
	var extensionRange : Array<google_cloud.secret_manager.build.protos.protos.google.protobuf.descriptorproto.IExtensionRange>;
	/**
	...
	**/
	@:optional
	var reservedRange : Array<google_cloud.secret_manager.build.protos.protos.google.protobuf.descriptorproto.IReservedRange>;
	/**
