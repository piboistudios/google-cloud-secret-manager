...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.GeneratedCodeInfo") extern class GeneratedCodeInfo {
	/**
	...
	**/
	public var annotation : Array<google_cloud.secret_manager.build.protos.protos.google.protobuf.generatedcodeinfo.IAnnotation>;
	/**
