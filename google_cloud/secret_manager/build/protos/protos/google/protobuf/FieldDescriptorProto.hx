...
**/
@:jsRequire("@google-cloud/secret-manager/build/protos/protos", "google.protobuf.FieldDescriptorProto") extern class FieldDescriptorProto {
	/**
	...
	**/
	public var label : ts.AnyOf2<Int, String>;
	/**
		FieldDescriptorProto type.
	**/
	public var type : ts.AnyOf2<Int, String>;
	/**
